$(function(){
    ...
    $('.remove-lote').live('click',function(){
        ...
        var url = baseUri +'/admin/cupom/removerCupom/'+id+'/';
...
function valida()
{
    if($.trim($('#categoria_title').val()) == "")
    {
        ...
        //$('#categoria_title').popover({placement:'top',title:'Campo Requerido',html: true, content:'Voc� precisa selecionar uma Categoria!'});
        return false;
    }
    else
    {
