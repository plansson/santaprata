...
class Cupom extends PHPFrodo
{
    ...
    */
    ...
    public function gerar()
    {
        ...
        {
            $this->cupom_alfa = $this->postGetValue( 'cupom_alfa' );
            ...
            $this->cupom_real = $this->postGetValue( 'cupom_real' );
            $this->postIndexDate( 'cupom_validade' );
            $this->cupom_validade = $this->postGetValue( 'cupom_validade' );


            $this->insert( 'cupom' )
                ->fields( array( 'cupom_alfa', 'cupom_desconto','cupom_real','cupom_validade','cupom_limite' ) )
                ->values( array( "$this->cupom_alfa","$this->cupom_desconto","$this->cupom_real","$this->cupom_validade","$this->cupom_limite" ) )
                ->execute();
            /*
            $this->lote_id = $this->objBanco->lastId();
            ...
            $this->query = "INSERT INTO cupom (cupom_alfa,cupom_lote, cupom_desconto,cupom_validade,cupom_limite,cupom_real) VALUES ";
            foreach ( $cupons as $alfa )
            {
                $this->query .= " ('$alfa',$this->lote_id,'$this->cupom_desconto','$this->cupom_validade','$this->cupom_limite','$this->cupom_real'), ";
            }
